...
<table style="width:100%; border-collapse: collapse;">
  ...
  <tr>
    ...
    <td>
      ...
      <strong>AV1:</strong> Participó en la organización y coordinación del equipo para el desarrollo de los capítulos I, II, III, IV y V del Project Report, incluyendo la planificación del Sprint 1 y la distribución de actividades.<br><br>

      <strong>Quispe Alomnacid, Andre Sebastian</strong><br>
      <strong>AV1:</strong> Participó en el desarrollo de los capítulos y artefactos asignados del Project Report, así como en las actividades correspondientes al Sprint 1.<br><br>

      <strong>Torres Huaman, Alexis Calin</strong><br>
      <strong>AV1:</strong> Participó en el desarrollo de los capítulos y artefactos asignados, además de colaborar en la organización de las actividades correspondientes al Sprint 1.<br><br>

      <strong>Merino Ordinola, Winnie Lisbeth</strong><br>
      <strong>AV1:</strong> Participó en el desarrollo de los capítulos y artefactos asignados del Project Report, colaborando en las actividades correspondientes al Sprint 1.<br><br>

      <strong>Integrante 5</strong><br>
      <strong>AV1:</strong> Participó en el desarrollo de los capítulos y artefactos asignados del Project Report, así como en las actividades correspondientes al Sprint 1.<br><br>
    </td>
    <td>
      <strong>AV1:</strong> El equipo demostró liderazgo compartido mediante la distribución de responsabilidades para desarrollar los capítulos I, II, III, IV y V del Project Report. Asimismo, la planificación del Sprint 1, la asignación de líderes y colaboradores y la organización del Sprint Backlog permitieron coordinar las actividades de implementación, documentación, ejecución y despliegue.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <strong>Cáceres Pizarro, Albino Florencio</strong><br>
      <strong>AV1:</strong> Participó en la planificación de las actividades, organización del repositorio y distribución de responsabilidades para el desarrollo del Project Report y del Sprint 1.<br><br>

      <strong>Quispe Alomnacid, Andre Sebastian</strong><br>
      <strong>AV1:</strong> Cumplió con las actividades asignadas para la elaboración de los capítulos, artefactos y evidencias correspondientes al Sprint 1.<br><br>

      <strong>Torres Huaman, Alexis Calin</strong><br>
      <strong>AV1:</strong> Colaboró en la planificación y organización de las tareas del equipo y en las actividades correspondientes al Sprint Planning y Sprint Backlog.<br><br>

      <strong>Merino Ordinola, Winnie Lisbeth</strong><br>
      <strong>AV1:</strong> Participó en las actividades asignadas para el desarrollo de los capítulos y artefactos del proyecto, coordinando sus avances con el equipo.<br><br>

      <strong>Integrante 5</strong><br>
      <strong>AV1:</strong> Participó en el cumplimiento de las actividades asignadas para el Project Report y el Sprint 1, colaborando con los demás integrantes del equipo.<br><br>
    </td>
    <td>
      <strong>AV1:</strong> La planificación y distribución de tareas permitió al equipo avanzar de manera organizada en los capítulos I, II, III, IV y V. El Sprint Planning, Sprint Backlog y la asignación de líderes y colaboradores permitieron establecer responsabilidades y coordinar el desarrollo de Software Configuration Management, Landing Page, evidencias del Sprint Review, despliegue, conclusiones y bibliografía.
    </td>
  </tr>
</table>
